 ...
 */
require_once $base_path . "Auth/OpenID.php";
require_once $base_path . "Auth/OpenID/HMACSHA1.php";
require_once $base_path . "Auth/OpenID/Association.php";
require_once $base_path . "Auth/OpenID/CryptUtil.php";
require_once $base_path . "Auth/OpenID/DiffieHellman.php";
require_once $base_path . "Auth/OpenID/KVForm.php";
require_once $base_path . "Auth/OpenID/Discover.php";
require_once $base_path . "Services/Yadis/Manager.php";
require_once $base_path . "Services/Yadis/XRI.php";
