...
require_once $base_path .  "Services/Yadis/PlainHTTPFetcher.php";
require_once $base_path .  "Services/Yadis/ParanoidHTTPFetcher.php";

/**
 * Need this for parsing HTML (looking for META tags).
 */
require_once $base_path .  "Services/Yadis/ParseHTML.php";

/**
 * Need this to parse the XRDS document during Yadis discovery.
 */
require_once $base_path .  "Services/Yadis/XRDS.php";
 ...
 *
 * <pre>  require_once $base_path .  "Services/Yadis/Yadis.php";</pre>
 *
